      ...
      <div className="col-lg-6">
        <div className="new_product">
          ...
          <div className="product-img">
            <img className="img-fluid" src="img/product/new-product/new-product1.png"  />
          </div>
          <h4>$120.70</h4>
        ...
        <div className="row">
          <div className="col-lg-6 col-md-6">
            <div className="single-product">
              <div className="product-img">
                <img className="img-fluid w-100" src="img/product/new-product/n1.jpg"  />
          ...
          <div className="col-lg-6 col-md-6">
            <div className="single-product">
              <div className="product-img">
                <img className="img-fluid w-100" src="img/product/new-product/n2.jpg"  />
                <div className="p_icon">
                  <a href="#">
                    <i className="ti-eye" />
                  </a>
          ...
          <div className="col-lg-6 col-md-6">
            <div className="single-product">
              <div className="product-img">
                <img className="img-fluid w-100" src="img/product/new-product/n3.jpg"  />
                <div className="p_icon">
                  <a href="#">
                    <i className="ti-eye" />
                  </a>
          ...
          <div className="col-lg-6 col-md-6">
            <div className="single-product">
              <div className="product-img">
                <img className="img-fluid w-100" src="img/product/new-product/n4.jpg"  />
                <div className="p_icon">
                  <a href="#">
                    <i className="ti-eye" />
                  </a>
